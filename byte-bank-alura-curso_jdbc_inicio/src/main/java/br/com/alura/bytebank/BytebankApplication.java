...
public class BytebankApplication {
    ...
    private static void realizarTransferencia(){
        ...
        var numeroDaContaDeOrigem = teclado.nextInt();

        System.out.println("Digite o número da conta de Destino:");
        var numeroDaContaDeDestino = teclado.nextInt();

        System.out.println("Digite o valor a ser transferido:");
        var valor = teclado.nextBigDecimal();

        service.realizarTransferencia(numeroDaContaDeOrigem, numeroDaContaDeDestino, valor);

        System.out.println("Transferência realizado com sucesso!");
        System.out.println("Pressione qua lquer tecla e de ENTER para voltar ao menu principal");
        teclado.next();
    }
}
